...
export const FAQS = [
  ...
  },
  {
    ...
    a: "No — the founding group is closed. Join the cohort two waitlist to lock in priority pricing at $249 ($50 off the $299 full price). We'll email you first when spots open.",
  },
  {
