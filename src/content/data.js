...
export const RECIPES = [
  ...
  { cat: "Breakfast", name: "High protein einkorn pancakes", desc: "Batch: 1 cup (226g) 2% cottage cheese (or full-fat Greek yogurt), 4 eggs, 1 cup (120g) einkorn flour, 1 tbsp honey, 1 tsp baking powder, ¼ tsp salt, 1 tsp vanilla; butter for the pan. Logged serving = 1 pancake (¼ cup batter). Batch makes about 8. A filling plate is usually 2–3.", cal: 130, p: 8, c: 13, f: 5, serves: 8 },
  ...
  { cat: "Dinner", name: "Callie's chicken teriyaki", desc: "1½ lbs boneless skinless chicken thighs; glaze: 3 tbsp honey + ¼ cup coconut aminos + garlic and ginger. Per serving: 6 oz raw thighs with ¼ of glaze, 1 cup (158g) cooked rice, 1 cup steamed broccoli.", cal: 540, p: 38, c: 64, f: 13, serves: 4 },
  ...
  { cat: "Dinner", name: "Chicken soba stir fry", desc: "1 lb diced chicken, soba noodles, coconut aminos sauce with sesame oil, honey, rice vinegar + garlic, scrambled eggs. Per serving (½ batch): ~805 cal.", cal: 805, p: 70, c: 74, f: 25, serves: 2 },
  { cat: "Dinner", name: "Laura's Juicy Chicken Meatballs", desc: "3 lb ground chicken breast + Parmesan, grated onion, garlic, sourdough breadcrumbs, yogurt, mayo, eggs + spices. Per serving: ⅛ of the batch.", cal: 436, p: 45, c: 15, f: 22, serves: 8 },
...
export const DAYS = ["M", "T", "W", "T2", "F", "S", "S2"];
export const DAY_LABEL = { M: "M", T: "T", W: "W", T2: "T", F: "F", S: "S", S2: "S" };
...
export const FEATURES = [
  ...
  { icon: "🍳", title: "A meal plan made for you", body: "Simple meal formulas plus 21 high-protein recipes with exact quantities and every macro counted. Then tell Callie what you love to eat, and get recipes adapted to your tastes — high-protein versions of your favorites." },
...
export const FAQS = [
  ...
  },
  {
    ...
    a: "No — the founding group is closed. Join the waitlist to lock in priority pricing at $249 ($50 off the $299 full price). We'll email you first when spots open.",
  },
  {
