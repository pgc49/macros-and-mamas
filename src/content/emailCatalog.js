...
Callie`,
  ...
  },
  {
    ...
    audience: "Callie",
    cta: null,
    bodyPreview: `Headline stats (age, weight, breastfeeding, tastes, phone) + deep link to /admin. Flags pregnant / early nursing / diet for 1:1 review — no auto-refund.`,
  },
  {
    ...
    status: "live",
    trigger: "Pregnant or early-nursing gate during intake (no auto-refund)",
    subject: "⚠️ [name] — pregnant / early nursing (no auto-refund)",
    audience: "Callie",
    cta: null,
    bodyPreview: `Name, email, reason. Reminder to reach out 1:1 and decide whether to refund in Stripe.`,
  },
  {
    id: "callie_refund",
    number: "C",
