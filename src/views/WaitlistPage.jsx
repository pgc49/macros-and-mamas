...
/** Dedicated waitlist signup (name, email, phone). */
    ...
    <Shell>
      <Card style={{ marginTop: 24, padding: 28 }}>
        ...
        <p style={{ fontSize: 15, lineHeight: 1.55, color: T.inkSoft, margin: "0 0 20px" }}>
          Founding is closed. Join the waitlist now for <b style={{ color: T.ink }}>$249</b> when the next
          group opens — that&apos;s <b style={{ color: T.ink }}>$50 off</b> the $299 full price. We&apos;ll email you
          a join link first.
        </p>
