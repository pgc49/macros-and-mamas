    ...
    const { data, error } = await resend.emails.send({
      ...
      html: renderEmail({
        ...
        body: `
          ...
          <p>Then your macros get built by me, not by a calculator. I personally review every mama's numbers before they go live. You'll get them within a day of finishing your intake, as flexible ranges, because real life doesn't happen in exact grams.</p>
          <p>Once your macros are approved, you'll find me in Messages in the app, your group with the other mamas. That's where I live Monday through Friday. Voice notes, plate pics, wins, questions, all of it. Every Monday I drop a short voice note that sets the week's focus. Listen while you pump, nurse, walk, or hide in the pantry. No judgment!</p>
